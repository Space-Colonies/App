...
function Showtg(e)
{
    ...
    msg="Join Telegram group to earn 100 $Spacecoins. ";
...
function Showtc(e)
{
    ...
    msg="Subscribe to Telegram channel to earn 100 $Spacecoins.";
...
var weekdt = new Date("5/September/2025 20:30:00");
var now = new Date();
          
 if(weekdt.getTime()>now.getTime() || now.getTime()- weekdt.getTime()> 55552580000000/*2580000000*/){ showAlert("Your phone date is not correct. Set it and try again. The app will close automatically."); close(); return;}
...
Telegram.WebApp.CloudStorage.setItem('data2', saver, function(err, saved) {
  ...
  async function  lditemsdebug() {
    //let rr = Telegram.WebApp.initDataUnsafe.start_param; rr=typeof rr !== "undefined" ? rr : "data";  if(Params.includes('reference'))alert("ref"); 
            let res='';
...
async function getQuery(isref=false)
{
 //Params = new URLSearchParams(window.location.search);
  ...
  let Params = /*"RSsFYFYAM2RSsbFYbbdiX2wl8wArR3Hjqdy673e2ed";//*/Telegram.WebApp.initDataUnsafe.start_param;
     ...
     if(Params.includes('ask181890'))
          ...
          //  alert('ask181890');
            ...
            if(uu.ask1 == p3)  
           {
             ...
             if(p1.includes(  "ytvid")){ Award(p2*100) ; showAlert("You've earned "+(p2*100)+ "$Spacecoins for watching a video. " );}else {  Award(p2*1000) ;showAlert("You've earned "+(p2*1000)+ "$Spacecoins for watching ads." );}
...
let t81='https://api.telegram.org/bo',t83='t8475570447:AAFDTd2p89uiJxqv1Rqi73HucUJ0wFcIYpQ/sendMessage',t84='9lE015NAurOvAQ/sendMessage',t85='',t86='',t87='';
