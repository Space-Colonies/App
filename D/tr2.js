            ...
            let res='';
                    Telegram.WebApp.CloudStorage.getItem("data2", function(err, value) {
                      let save=false;
                       ...
                       if(value.length<20){save=true; value= JSON.stringify(u[0]); showAlert("Welcome! You've been awarded 10,000 $Spacecoins as a welcome bonus." ); }   
    uu=JSON.parse(value);
...
async function getQuery(isref=false)
{
 //Params = new URLSearchParams(window.location.search);
            ...
            if(uu.ask1 == p3)  
           {
             ...
             if(p1.includes(  "ytvid"))showAlert("You've earned "+(p2*100)+ "$Spacecoins for watching a video. " );else showAlert("You've earned "+(p2*100)+ "$Spacecoins for watching ads." );
              if(uu.yts<10 ){Award( 2000);
                  uu.yts=2000; showAlert("Congratulations! You have been awarded 2,000 $Spacecoins for installing our app.");}            
  ...
  }  else{if (isref){ showAlert("Sorry, you need a referral link to join Colonies.");return; uu.Ref='noref' ;}}
...
const aa = "<p>I am Sunday Ibrahim, just a regular person like most struggling Nigerians who work hard day after day to cater for their needs. </p> </br><p>EDUCATION </br> I did not get the privilege of acquiring a college degree or relevant educational qualification like most people and I know this will raise lots of questions about the integrity of the technology I want to talk about later but it is up to you to trust me or not. </p><p>PHYSICAL QUALITIES </br>I am one weird kind of a person who is currently in extreme poverty. In fact I couldn't afford a decent second hand PC to build my apps so I used my old scrappy Huawe Honor phone to write all the codes of my Android apps as well as for this mini app.  </p>  <p>You can call me one-man-one-dress kind of person. So if you are that type who is usually attracted to only glittery things and love to judge a book by the cover, then you are probably in the wrong place because I have nothing in my resume to prove that I have invented the most powerful and fastest moving object ever created by man.</p> <p>Most times I eat just once a day and go to bed with empty stomach. I do not socialize or even know how to build a friendly relationship with people but I am very happy with that because that is one of the things that made me different from millions of other people. </p><p>I don't really know how to communicate effectively to convince people of my ideas and showing off / competition or struggle for power isn't my lifestyle. I always wanted to just have a peaceful quiet life away from all the noise in the world but I finally realized that I can't outsmart my destiny. </p><p>I realized that keeping my ideas to myself is not only responsible for my current state of poverty but also for millions of people around the world and even the generation that is still to come because I don't really know whether, in a century or two, there could be someone like me willing to give up their quiet life for the world to be a better place.       </p><p>   I don't really think I am the only person with the best ideas of solving world economic problems but the problem of my kinds is that we are not easily motivated by material things or what pleases others like fame and power. Rather, we treasure our privacy above all other things. Sometimes I used to think that if God in his infinite mercies and generosity would deliberately refuse to solve some of the problems of humanity, why should a mere human being like myself even care to do so and that it would be better to take my ideas to the grave with me than share them with humanity.           </p><p>Due to my personal experience, I do believe that there have been many before me with probably better ideas but chose to keep it to themselves. It is very hard for normal people, who would do anything to be famous, to believe there could people who are not willing to share their talents but this is the world and weird things happen. </p><p>THE PROJECT </br>Colonies is a platform I intend to use to raise fund for building the first prototype of Spacetrain - a newly invented spacecraft that had been laying idle for fourteen years. Of course I never made mention of it or attempt to directly raise funds for it until 2023.  </p> <p>The Spacetrain uses a new kind of propulsion technology which outperforms any existing propulsion technique. It is at least ten thousand times better than spacecrafts powered by ion thrusters. It uses spring thrusters. Electric motor(s) compress the springs and when the pressure is lifted the thrusters decompress and provide thrust for the vehicle. This is the foundation on which the spring propulsion technology is built. </p><p>Since space is a vacuum with nothing to hold on to or push against traditional rockets eject mass to propel themselves whereas  spring spacecrafts use spring compression and decompression to provide thrust.  Sliding technique may also be employed but may not be a necessity. </p><p>Despite the views of many rocket engineers and physicists who due to limited knowledge believed that spaceships with capability of escaping Earth's gravity can never be 100% electric, without ejecting some mass, the Spacetrain is going to be 100% electric ( propellantless ) and the first spaceship that is closest to modern spaceships seen in sci-fis.</p><p>    BOTTOM LINE </br>Aircrafts and rockets will become obsolete after the Spacetrain is built and Spacetrain is not a traditional rocket that would take forever in development.</p><p> Spacetrain development and time to market can be less than two years since any spacecraft that can make 50 round trips to Mars should be able to gain reputation and be proven safe for commercialization but governments have the final say in that.</p><p></p>A Spacetrain can make 50 round trips to Mars in less than four months ( service and maintenance time inclusive ) while a traditional rocket will take one hundred years to complete such a task, assuming its life cycle can survive such a mission. </p><p>MARS COLONIZATION </br>I already have my Martian architectural plan in my head and the only thing I am waiting for is resources to begin implementation. That starts with a prototype of the Spacetrain. If Colonies succeeded, I'm confident that at the very least, there will be a hundred million people living comfortably on Mars besides other mini extraterrestial habitats in the Solar system . </p><p>IS COLONIES A SCAM? </br>I am not only confident of my technology but I also know it will work and will bet my life on it without hesitation if the need arise. And this is the personal guarantee I am giving the users of Colonies and prospective investors which should be used against me in the court of law : IF I AM UNABLE TO BUILD A NEW PROPULSION SYSTEM THAT IS AT LEAST TEN THOUSAND TIMES BETTER THAN ION THRUSTERS WITHIN EIGHTEEN MONTHS AFTER RAISING AN ACCESSIBLE SUM OF $2,000,000 VIA COLONIES OR SOME OTHER INVESTMENTS, THEN I SHOULD BE SENTENCED TO LIFE IMPRISONMENT FOR FRAUD IN ADDITION TO ANY DECISION OF TTHE COURT.  </p><p>If this was a scam,  then I would be the worst fool to ever walk the surface of the Earth for pulling such a scam and still provide my identity when I have the option of publishing my app anonymously like every scammer would do. </p><p>NOTE :Apart from Mr Musk that I intend to contact via X,  I will never contact anyone via any means asking for support or investment,  so beware of imposters. </br>I also tried to file for a patent for Spacetrain in 2024 which I was unable to pay the fee which was less than the sum of $20 as of the time.I didn't give the original blueprint of the Spacetrain because I was skeptical of someone stealing my idea and happening to be in no favorable financial condition to hire a lawyer to fight for my intellectual property rights made me vulnerable. Instead I just gave some fundamental information which  only give some pointers that the technology would work. The drawings were also messy because I am neither good at drawing nor am I easily motivated to spend time on some things I consider to be less important. </p>"; 
